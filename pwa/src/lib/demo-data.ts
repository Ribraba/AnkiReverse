...
export const DEMO_CARDS = [
  ...
  card(1001, "Anglais::Vocabulaire", "Serendipity", "Sérendipité — la faculté de faire des <b>découvertes heureuses</b> par hasard", 2, 3, 2500, 8, ["vocab", "b2"]),
  card(1002, "Anglais::Vocabulaire", "Ephemeral", "Éphémère — qui ne dure qu'un <b>très court moment</b>", 2, 2, 2300, 5, ["vocab"]),
  card(1003, "Anglais::Vocabulaire", "Ubiquitous", "Omniprésent — qui se trouve <b>partout à la fois</b>", 2, 4, 2500, 12, ["vocab", "c1"]),
  card(1004, "Anglais::Vocabulaire", "Pragmatic", "Pragmatique — orienté vers <b>l'action concrète</b> plutôt que la théorie", 2, 2, 2200, 4, ["vocab"]),
  ...
  card(2001, "Histoire::Révolution Française", "Prise de la Bastille", "<b>14 juillet 1789</b> — Symbole du début de la Révolution française", 2, 5, 2500, 15, ["dates"]),
  card(2002, "Histoire::Révolution Française", "Déclaration des droits de l'Homme", "<b>26 août 1789</b> — Texte fondateur des droits civiques", 2, 3, 2400, 9, ["dates"]),
  ...
  card(2004, "Histoire::Révolution Française", "Début du Directoire", "<b>26 octobre 1795</b> — Fin de la Convention, début d'un gouvernement de 5 directeurs", 2, 4, 2300, 6, ["dates"]),

  // Informatique::Algorithmes — révisions
  card(3001, "Informatique::Algorithmes", "Complexité du <b>QuickSort</b> (cas moyen)", "<code>O(n log n)</code> — pivot aléatoire, récursion sur deux sous-listes", 2, 3, 2500, 7, ["complexity"]),
  card(3002, "Informatique::Algorithmes", "Complexité du <b>tri par insertion</b> (pire cas)", "<code>O(n²)</code> — tableau trié en sens inverse", 2, 2, 2100, 3, ["complexity"]),
  // Nouvelles
